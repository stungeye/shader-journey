...
Below I'll review some of the GLSL ecosystem and explain how I'm running GLSL shaders as React components on this site using Docusaurus.
...
[The full source code of my component can be seen here](https://github.com/stungeye/shader-journey/blob/master/src/theme/ResponsiveShader.js).
...
useEffect(() => {
  ...
  // This returned function is run when the component unmounts
...
This was the fix I needed, although I needed to require in glslCanvas with a `require` rather than an `import`, as `import` statements can't be nested. The relevant code is:
...
You can see [the full component source code here](https://github.com/stungeye/shader-journey/blob/master/src/theme/ResponsiveShader.js).
