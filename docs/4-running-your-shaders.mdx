...
In [chapter 4 of the Book of Shaders](https://thebookofshaders.com/04/) we learn how to display and edit our shaders across different platforms (Linux, Mac, Windows, Raspberry Pi, Browser).
