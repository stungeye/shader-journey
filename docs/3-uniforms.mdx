...
export const Shader = function () {
  if (ExecutionEnvironment.canUseDOM) {
    ...
    const shader = `precision mediump float; void main() { gl_FragColor = vec4(1, 0, 0, 1); }`;
    ...
    return <ShaderCanvas width={width} height={240} fragShader={shader} />;
  } else {
    return <></>;
  }
};
...
<iframe
  ...
  height="360"
  frameborder="0"
  src="https://www.shadertoy.com/embed/3tscz7?gui=true&t=10&paused=true&muted=false"
  allowfullscreen
></iframe>
